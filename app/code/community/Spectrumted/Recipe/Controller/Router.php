 ...
 */
class Spectrumted_Recipe_Controller_Router extends Mage_Cms_Controller_Router
{
    ...
    public function initControllerRouters($observer)
    {
        ...
        $front->addRouter('spectrumted_recipe', $this);
    }
    private $_frontendName;
    private function getFrontendName(){
        if (!$this->_frontendName){
            $this->_frontendName = Mage::getStoreConfig('recipe/general/frontend_url_key');
            if (!$this->_frontendName){
    ...
    public function match(Zend_Controller_Request_Http $request)
    {
        ...
        Mage::dispatchEvent('spectrumted_recipe_controller_router_match_before', array(
            'router'    => $this,
            'condition' => $condition
        ));
        ...
        foreach($modelsToCheck as $modelName){
            $model = Mage::getModel('spectrumted_recipe/' . $modelName);
            if ($model instanceof Spectrumted_Recipe_Model_IFrontendRoute){
