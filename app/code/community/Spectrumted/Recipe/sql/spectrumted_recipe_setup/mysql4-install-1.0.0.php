...
if (!version_compare(Mage::getVersion(), '1.6', '>=')) {
    $installer->run(
        "DROP TABLE IF EXISTS {$this->getTable('spectrumted_recipe/post')};
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE {$this->getTable('spectrumted_recipe/post')} (
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='spectrumted_recipe_post';
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS  {$this->getTable('spectrumted_recipe/category')};
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE {$this->getTable('spectrumted_recipe/category')} (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  ...
  PRIMARY KEY (`entity_id`),
  UNIQUE KEY `IDX_CMS_IDENTIFIER` (`cms_identifier`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='spectrumted_recipe_category';
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS {$this->getTable('spectrumted_recipe/tag')};
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE {$this->getTable('spectrumted_recipe/tag')} (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `status` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Defines Is Entity Active',
  `name` text NOT NULL COMMENT 'Post Content',
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='spectrumted_recipe_tag';
/*!40101 SET character_set_client = @saved_cs_client */;

DROP TABLE IF EXISTS {$this->getTable('spectrumted_recipe/comment')};
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE {$this->getTable('spectrumted_recipe/comment')} (
  `entity_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Entity Id',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT 'Created At',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT 'Updated At',
  `status` smallint(5) unsigned NOT NULL DEFAULT '1' COMMENT 'Defines Is Entity Active',
  ...
  PRIMARY KEY (`entity_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='spectrumted_recipe_comment';
/*!40101 SET character_set_client = @saved_cs_client */;
");
}
else{
$table = $installer->getConnection()
        ->newTable($this->getTable('spectrumted_recipe/post'))
...
$table = $installer->getConnection()
        ->newTable($this->getTable('spectrumted_recipe/category'))
        ->addColumn('entity_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'identity' => true,
            'unsigned' => true,
            'nullable' => false,
...
$table = $installer->getConnection()
        ->newTable($this->getTable('spectrumted_recipe/tag'))
        ->addColumn('entity_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'identity' => true,
            'unsigned' => true,
            'nullable' => false,
...
$table = $installer->getConnection()
        ->newTable($this->getTable('spectrumted_recipe/comment'))
        ->addColumn('entity_id', Varien_Db_Ddl_Table::TYPE_INTEGER, null, array(
            'identity' => true,
            'unsigned' => true,
            'nullable' => false,
