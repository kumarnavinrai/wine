...
$installer->getConnection()
        ->addKey($installer->getTable('spectrumted_recipe/post'), 'IDX_CMS_IDENTIFIER', array('cms_identifier'), 'unique');
$installer->getConnection()
        ->addKey($installer->getTable('spectrumted_recipe/category'), 'IDX_CMS_IDENTIFIER', array('cms_identifier'), 'unique');
$installer->endSetup();
