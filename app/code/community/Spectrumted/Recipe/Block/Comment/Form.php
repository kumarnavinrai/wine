 ...
 */
class Spectrumted_Recipe_Block_Comment_Form
extends Mage_Core_Block_Template 
implements Mage_Widget_Block_Interface
{	
    function _construct(){
        $typeTemplate  = Mage::getStoreConfig('recipe/comment/type_template');
        if (!$typeTemplate){
            $typeTemplate = 'spectrumted/recipe/comment/form/default.phtml';
        }
