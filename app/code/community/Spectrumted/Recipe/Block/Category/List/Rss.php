 ...
 */
class Spectrumted_Recipe_Block_Category_List_Rss
extends Spectrumted_Recipe_Block_Category_List 
implements Mage_Widget_Block_Interface
{	
    function _construct(){
        $this->setTemplate('spectrumted/recipe/category/list/rss.phtml');   
    }    
    function _toHtml(){
        return (Mage::helper('spectrumted_recipe')->isRSSActive())? parent::_toHtml() : '' ;
    }
}