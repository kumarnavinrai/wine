...
class Spectrumted_Recipe_Block_Adminhtml_Post_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
         ...
         $this->_updateButton('save', 'label', Mage::helper('spectrumted_recipe')->__('Save Comment'));
	 $this->_updateButton('delete', 'label', Mage::helper('spectrumted_recipe')->__('Delete Comment'));
     ...
     public function getHeaderText()
     {
         if( Mage::registry('current_comment') && Mage::registry('current_comment')->getId() ) {
             return Mage::helper('spectrumted_recipe')->__("Edit Comment '%s'", $this->htmlEscape(Mage::registry('current_comment')->getTitle()));
         } else {
             return Mage::helper('spectrumted_recipe')->__('Add Comment');
         }
     }
}