 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Post extends Mage_Adminhtml_Block_Widget_Grid_Container {

    public function __construct() {
        $this->_controller = 'adminhtml_post';
        $this->_blockGroup = 'spectrumted_recipe';
        $this->_headerText = Mage::helper('spectrumted_recipe')->__('Post Manager');
        $this->_addButtonLabel = Mage::helper('spectrumted_recipe')->__('Add Post');
        parent::__construct();
        $this->setTemplate('spectrumted/recipe/post.phtml');
    }
