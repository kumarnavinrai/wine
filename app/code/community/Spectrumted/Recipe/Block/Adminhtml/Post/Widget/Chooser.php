 ...
 *
 * @category    modules
 * @module      Spectrumted_ImageRotator
 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Post_Widget_Chooser
extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/spectrumted_recipe_widget/postchooser', array(
            'uniq_id' => $uniqId,
        ...
        if ($element->getValue()) {
            ...
            if (intval($postId) > 0) {
                ...
                $label .= Mage::getSingleton('spectrumted_recipe/post')->load($postId)->getTitle();
            }
    ...
    public function getCheckboxCheckCallback()
    {
        if ($this->getUseMassaction()) {
            return "function (grid, event) {
                $(grid.containerId).fire('spectrumted_recipe:changed', {});
            }";
        }
    }
   ...
   /* public function getCategoryClickListenerJs()
    ...
    {
        $this->setCollection(Mage::getResourceModel('spectrumted_recipe/post_collection'));
   ...
   protected function _prepareColumns()
    {
        ...
        $this->addColumn('chooser_status', array(
             ...
             'type'      => 'options',
             'name'      => 'chooser_status',
             'options'   =>  Mage::getSingleton('spectrumted_recipe/attribute_source_status')->toOptionArray()
