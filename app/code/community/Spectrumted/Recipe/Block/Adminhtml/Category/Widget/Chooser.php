 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Category_Widget_Chooser
extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/spectrumted_recipe_widget/categorychooser', array(
            'uniq_id' => $uniqId,
        ...
        if ($element->getValue()) {
            ...
            if (intval($categoryId) > 0) {
                $category = Mage::getModel('spectrumted_recipe/category')->load($categoryId);
    ...
    {
        $collection = Mage::getResourceModel('spectrumted_recipe/category_collection')
