 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Category_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
         ...
         $this->_updateButton('save', 'label', Mage::helper('spectrumted_recipe')->__('Save Category'));
	 $this->_updateButton('delete', 'label', Mage::helper('spectrumted_recipe')->__('Delete Category'));
    ...
    public function getSaveUrl()
    {
     ...
     public function getHeaderText()
     {
         ...
         if( Mage::registry('current_category') && Mage::registry('current_category')->getId() ) {
             return Mage::helper('spectrumted_recipe')->__("Edit Category '%s'", $this->htmlEscape(Mage::registry('current_category')->getName()));
         } else {
             return Mage::helper('spectrumted_recipe')->__('Add Category');
         }
     }
