 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Category_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
   public function __construct()
   {
        ...
        $this->setTitle(Mage::helper('spectrumted_recipe')->__('Categories'));
   }
    ...
    protected function _prepareLayout()
    {
        $this->addTab('form_section', array(
        			  'label'     => Mage::helper('spectrumted_recipe')->__('Item Information'),
        			  'title'     => Mage::helper('spectrumted_recipe')->__('Item Information'),
         			  'content'   => $this->getLayout()->createBlock('spectrumted_recipe/adminhtml_category_edit_tab_form')->toHtml(),
        ...
        $this->addTab('design_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('spectrumted_recipe/adminhtml_category_edit_tab_design')->toHtml(),
        ...
        $this->addTab('meta_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('spectrumted_recipe/adminhtml_category_edit_tab_meta')
                    ->toHtml(),
        ));
