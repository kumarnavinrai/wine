 ...
 */
class Spectrumted_Recipe_Block_Adminhtml_Category extends Mage_Adminhtml_Block_Widget_Grid_Container {
    ...
    public function __construct() {
        ...
        $this->_headerText = Mage::helper('spectrumted_recipe')->__('Category Manager');
        $this->_addButtonLabel = Mage::helper('spectrumted_recipe')->__('Add Category');
        parent::__construct();
        $this->setTemplate('spectrumted/recipe/category.phtml');
    }
