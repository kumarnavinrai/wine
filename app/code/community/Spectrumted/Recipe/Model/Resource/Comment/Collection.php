 ...
 */
class Spectrumted_Recipe_Model_Resource_Comment_Collection 
extends Spectrumted_Recipe_Model_Resource_Abstract_Status_Collection
{
    function _construct()
    {
    ...
    function addPostData(){
        $this->getSelect()->join(array("post" => $this->getTable('spectrumted_recipe/post')), 'main_table.post_id = post.entity_id', array('title', 'author', 'post_date'));
        return $this;
    }
