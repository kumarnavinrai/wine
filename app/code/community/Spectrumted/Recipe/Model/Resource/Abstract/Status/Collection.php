 ...
 */
abstract class Spectrumted_Recipe_Model_Resource_Abstract_Status_Collection 
extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     * params: (int) $status - object specific Status, defined in the object itself eg: Spectrumted_Recipe_Model_Post
     */
